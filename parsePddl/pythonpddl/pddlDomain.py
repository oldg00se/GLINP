...
from antlr4 import *
from parsePddl import pddlLexer
from parsePddl import pddlParser
import itertools
import sys
...
class Formula:
    ...
    def asPDDL(self):
        ...
        elif self.op in ['and','or','>', '<', '=', '>=', '<=', 'increase', 'decrease', 'assign', 'scale-up', 'scale-down']:
...
def parseDomainAndProblem(domainfile):
